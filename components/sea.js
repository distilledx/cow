        ...
        <>
            <svg>
                <filter id="turbulence" x="0" y="0" width="100%" height="100%">
                    ...
                    <animate xlinkHref="#sea-filter" attributeName="baseFrequency" dur="45s" keyTimes="0;0.5;1" values="0.02 0.06;0.04 0.08;0.02 0.06" repeatCount="indefinite" />
                </filter>
            </svg>

            <div className={mainstyles['sea']}>
                <img alt="" src="/Images/backdrop7.png" className={mainstyles['backdrop']} />
                <StarComponent number={18000} class_={mainstyles['star-bottom']} n={1.25} name={'sea_canvas'} />
